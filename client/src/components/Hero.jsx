...
const Hero = () => {
  ...
  return (
    <div className='px-4 sm:px-20 xl:px32 relative inline-flex flex-col
    ...
    min-h-screen'>
        <div className='text-center mb-6'>
            ...
            font-semibold mx-auto leading-[1.2]'>Create amazing content <br />with <span 
            className='text-primary'>AI Tools</span></h1>
            <p>Transform your content creation with our suite of premium AI Tools.
                 Write articles, genrate images, and enhance your workflow.</p>
        </div>
        <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
            ...
            <button className='bg-white px-10 py-3 border 
