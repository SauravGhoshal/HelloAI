    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        <div className='flex items-center gap-3'>
          <Sparkles className='w-6 text-[#0d9908]' />
          <h1 className='text-xl font-semibold'>AI Title Generoator</h1>
        </div>
            ...
            <span
              ...
              className={`text-xs px-4 py-1 border rounded-full cursor-pointer 
                ${selectedCategory === item
                  ? 'bg-green-100 text-green-700 border-blue-200'
        ...
        bg-gradient-to-r from-[#037e36] to-[#06b175] text-white px-4 py-3 mt-6
      ...
      '>
        <div className='flex items-center gap-3'>
          <Hash className='w-5 h-5 text-[#069a4b]'/>
